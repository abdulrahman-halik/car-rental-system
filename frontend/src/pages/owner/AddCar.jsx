...
const AddCar = () => {
    ...
    const onSubmitHandler = async (e) => {
        e.preventDefault();
        // Demonstration of what would happen
        alert("Car added successfully! (Demo Mode)");
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
                    ...
                    >
                        ...
                        <div className="w-full">
                            <p className="text-sm font-medium text-gray-700 mb-2">Car Image</p>
                            <label
                                htmlFor="car-image"
                                className="flex flex-col items-center justify-center w-full h-48 md:h-64 border-2 border-dashed border-gray-300 rounded-xl cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors duration-200 group overflow-hidden relative"
                            >
                                <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                    {image ? (
                                        ...
                                        <>
                                            ...
                                            <p className="mb-1 text-sm text-gray-700 font-medium">Click to upload car image</p>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div className="space-y-1">
                                    <label className="text-sm font-medium text-gray-700">Daily Price ({currency})</label>
                                    <input
                                        type="number"
                                        placeholder="10000"
                                        required
